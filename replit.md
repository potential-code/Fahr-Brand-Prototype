...
- `docker-compose.yml` — the two app services (`fahr-platform` on port 80, `api-server` on 8080), built from `artifacts/*/Dockerfile`. No database service: nothing in the deployed app uses one yet.
