...
const translations = {
  en: {
    ...
    "nav.mission": "Development Mission",
    "nav.agent": "AI Agent",
    ...
    "btn.start": "Start today's mission",
    "btn.twin": "Continue AI Digital Twin",
    "btn.lab": "Open Agentic AI Lab",
    "btn.submit": "Submit Outcome Project",
  },
  ar: {
    "nav.learner": "المتعلم",
