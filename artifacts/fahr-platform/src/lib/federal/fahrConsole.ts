...
export const INTEGRATIONS: Integration[] = [
  ...
  {
    id: "sso",
    name: "Entity SSO Federation",
    vendor: "Azure AD / SAML 2.0",
    category: "Identity",
    purpose: "Entity-managed sign-in for staff who reach the platform from their own directory.",
    reference: "§7.3 Identity · TECH-02",
    status: "Connected",
    lastSync: "Today, 06:15",
    direction: "Inbound",
    records: 14,
    owner: "Obaid Al Marri",
    dataPoints: ["SAML assertion", "Group to role mapping", "Entity domain"],
  },
  {
    id: "hris",
  ...
  {
    id: "bi",
    name: "Federal BI Warehouse",
    vendor: "Microsoft Power BI",
    category: "Analytics",
    purpose: "Feeds programme metrics to the federal leadership reporting warehouse.",
    reference: "§7.3 BI · FR-04",
    status: "Degraded",
    lastSync: "Yesterday, 22:10",
    direction: "Outbound",
    records: 41850,
    owner: "Maitha Al Suwaidi",
    dataPoints: ["Engagement facts", "Capability distribution", "Project impact"],
    statusNote: "Last nightly push retried twice — warehouse rejected 38 rows with an unmapped entity code.",
  },
  {
    id: "m365",
    name: "Microsoft 365",
    ...
    purpose: "Calendar invitations, learning reminders and document hand-off for projects.",
    reference: "§7.3 Microsoft 365",
    status: "Connected",
    lastSync: "Today, 08:05",
    direction: "Outbound",
    owner: "Obaid Al Marri",
    dataPoints: ["Calendar events", "Mail", "OneDrive project files"],
  },
  {
    id: "teams",
    name: "Teams & Zoom Sessions",
    vendor: "Microsoft Teams · Zoom",
    category: "Productivity",
    purpose: "Hosts virtual clinics and cohort sessions, and returns attendance.",
    reference: "§7.3 Virtual delivery",
    status: "Connected",
    lastSync: "Today, 08:05",
    direction: "Bi-directional",
    records: 1260,
    owner: "Maitha Al Suwaidi",
    dataPoints: ["Meeting links", "Attendance", "Recording links"],
  },
  {
    id: "content",
    name: "Content Repositories",
    vendor: "SCORM · xAPI · entity LMS",
    category: "Content",
    purpose: "Ingests entity and vendor learning content into the federal catalogue.",
    reference: "§4.8 Catalogue",
    status: "Connected",
    lastSync: "26 July 2026, 19:30",
    direction: "Inbound",
    records: 412,
    owner: "Maitha Al Suwaidi",
    dataPoints: ["SCORM packages", "xAPI statements", "Competency tags"],
  },
  {
    id: "rest",
    name: "Platform REST API",
    vendor: "FAHR AI Learning Platform",
    category: "API",
    purpose: "Programmatic access for entity systems and the federal data office.",
    reference: "TECH-02 API access",
    status: "Connected",
    lastSync: "Live",
    direction: "Bi-directional",
    owner: "Obaid Al Marri",
    dataPoints: ["/v1/users", "/v1/pathways", "/v1/credentials", "/v1/reports"],
  },
  {
    id: "gov-registry",
    name: "National Credential Registry",
    vendor: "Government verification service",
    category: "API",
    purpose: "Publishes issued credentials for public verification by code.",
    reference: "§4.6 Certification",
    status: "Not connected",
    lastSync: "—",
    direction: "Outbound",
    owner: "Sultan Al Rashdi",
    dataPoints: ["Verification code", "Credential title", "Issuing entity"],
    statusNote: "Awaiting the federal verification service's production certificate.",
  },
];
