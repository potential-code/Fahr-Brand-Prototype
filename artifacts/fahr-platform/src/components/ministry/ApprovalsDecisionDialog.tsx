...
> = {
  ...
  return: {
    title: "Return to the line manager",
    verb: "Return",
    description: "The project goes back to the line manager to work with the learner. Tell them what to fix.",
    noteRequired: true,
    placeholder: "Required — what the line manager and learner need to address before resubmitting.",
    icon: Undo2,
    tone: "text-amber-600",
